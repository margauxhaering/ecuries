...
const images2 = document.querySelectorAll(".gallery-img2");

let currentIndex2 = 0;

// Fonction pour mettre à jour la position de la galerie
function updateGalleryPosition2() {
    gallery2.style.transform = `translateX(${-currentIndex2 * 100}%)`;
}
